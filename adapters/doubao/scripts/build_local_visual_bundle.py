...
4. 第 3 步必须完整保留：Keep / Adjust / Avoid、三套视觉公式、每套公式的 Jennie 逻辑、为你调整、强度、站立/坐下/走路/抬手试穿检查，以及主色层级、配饰结构、妆发态度、季节与室内外切换、材质桥接、衣橱升级、购买建议、7 天审美练习。
...
推荐提示词：`请完整读取压缩包并直接交付 assets/JENNIE_STYLE_DECODER_APP.html，不要从零重写。保留全部 53 张图、动态去重选图，以及第 3 步所有个性化建议模块，包括衣橱升级和购买建议；严格按 SKILL.md 和 APP_BUILD_SPEC.md 验收。`
